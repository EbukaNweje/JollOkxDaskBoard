...
const UpdateWallet = ({Display}) => {
  ...
  // const [sessionTime, setSessionTime] = useState()
    ...
    const url = `https://jollokxbackend.onrender.com/api/alluserdata`
  ...
  useEffect(()=>{
      ...
      const deleteprofile = (id) => {
        const url = `https://jollokxbackend.onrender.com/api/userdata/${id}`
        axios.delete(url)
        .then(res => {
          console.log(res)
          window.location.reload()
      ...
      const updateprofile = (id) => {
        const updateuserurl = `https://jollokxbackend.onrender.com/api/userdata/${id}`
